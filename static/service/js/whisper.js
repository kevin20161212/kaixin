...
var socket = new WebSocket("ws://"+document.domain+":2345");
...
layui.use(['upload', 'layer'], function () {
    ...
    var uploadInstImg = upload.render({
        ...
        , url: '/index.php/service/upload/uploadImg' // 上传接口
        , done: function (res) {
    ...
    var uploadInstFile = upload.render({
        ...
        , accept: 'file'
        , exts: 'zip|rar'
        , url: '/index.php/service/upload/uploadFile' // 上传接口
        , done: function (res) {
...
function loginOut(){
    ...
    if(len == closeNum){
        window.location.href = '/index.php/service/login/loginOut';
    }
