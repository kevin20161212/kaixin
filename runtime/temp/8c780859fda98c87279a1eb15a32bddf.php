<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"E:\anzhuan\object\kaixni11/application/store\view\index\index.html";i:1535610032;s:43:"./application/admin/view/public/layout.html";i:1528710982;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="utf-8">
            ...
            <div>
                ...
                <div class="collapse navbar-collapse navbar-collapse-top">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <i class="fa fa-user"></i> <?php echo $_merch_auth['username']; ?> <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a target="_blank" href="__ROOT__/"><i class="fa fa-external-link"></i> 打开前台</a></li>
                                ...
                                <li><a href="<?php echo U('Store/Login/logout'); ?>" class="ajax-get"><i class="fa fa-sign-out"></i> 退出</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
