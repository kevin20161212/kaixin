...
vendor('ali.api_sdk.vendor.autoload');
...
class Ali
{
    ...
    public static function getAcsClient() {
	   ...
	   //产品名称:云通信流量服务API产品,开发者无需替换
        ...
        $accessKeyId = C('SMS_accessKeyId'); // AccessKeyId
        	
		
		$accessKeySecret = C('SMS_accessKeySecret'); // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$title,$time) {
        ...
        $request->setTemplateCode(C('SMS_TemplateCode'));
      ...
      //  $request->setSmsUpExtendCode("1234567");
        ...
        $data = self::object2array($acsResponse);
     ...
     * @return stdClass
     */
    public static function classsendSms($phone,$num,$tel) {
        ...
        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode('SMS_137420866');
...
// $response = Ali::sendBatchSms();
// echo "批量发送短信(sendBatchSms)接口返回的结果:\n";
// print_r($response);

// sleep(2);

// $response = Ali::querySendDetails();
