...
$_config = [
    /**
     * 根据有范科技用户协议：
     * 任何情况下使用有范科技均需获取官方授权，违者追究法律责任，授权联系：http://www.youfai.cn
     */
    'product_name'           => 'YFTHINK', // 产品名称
    'product_title'          => 'YFTHINK', // 产品标题
    'logo_default'           => 'YFTHINK', // 产品Logo
    'logo_inverse'           => 'YFTHINK', // 产品Logo深色背景
    'current_version'        => '1.0.0', // 当前版本号
    'develop_version'        => 'beta3', // 开发版本号
    'build_version'          => '201712021200', // 编译标记
    'model_name'             => 'yfadmin', // 产品型号
    'model_title'            => '后台版', // 产品型号标题
    'website_domain'         => 'http://www.youfai.cn', // 官方网址
    'update_url'             => '/appstore/home/core/update5464564', // 官方更新网址
    'team_title'             => '山东有范网络科技有限公司', // 公司名称
    'team_member'            => '', // 团队成员
    'team_address'           => '', // 公司地址
    'team_email'             => 'youfai@youfai.cn', // 公司邮箱
    'team_phone'             => '15005173785', // 公司电话
    'team_qq'                => '280962430', // 公司QQ
    'team_qqqun'             => '280962430', // 公司QQ群
    ...
    // 注册的根命名空间
    'root_namespace'         => [
        'yfthink' => APP_DIR . 'common/util/yfthink/',
        'WeChat' => __ROOT__ . 'vendor/zoujingli/wechat-developer/WeChat/',
        'Endroid\QrCode'=> __ROOT__.'vendor/endroid/qr-code/src/',
        // 'Workerman'=>__ROOT__.'vendor/workerman-chat/workerman/',
        // 'GatewayWorker'=>__ROOT__.'vendor/workerman-chat/gateway-worker/src/',
      
        'Workerman'=>__ROOT__.'vendor/Workerman/workerman',
        'GatewayWorker'=>__ROOT__.'vendor/Workerman/gateway-worker/src',
        'Workerman\MySQL'=>__ROOT__.'vendor/Workerman/mysql/src',
        'GlobalData'=>__ROOT__.'vendor/Workerman/globaldata/src',
        // 'Events'=>'application/workman/controller/'
        // 'GatewayWorker'=>__ROOT__.'vendor/Workerman/gateway-worker/src/',
        // 'Workerman'=>__ROOT__.'vendor/Workerman-master/',
        // 'think\worker'=>__ROOT__.'vendor/Workerman/src/',
    ],
    // 扩展配置文件
    ...
    'template'               => [
        ...
        'taglib_end'      => '>',
        // 预先加载的标签库
        'taglib_pre_load' => '\\app\\common\\taglib\\Yfthink',
    ],
    ...
    if (@$_SERVER[ENV_PRE . 'DEV_MODE'] === 'true') {
        ...
        $db_config = array(
            'database' => [
                ...
                // 数据库名
                'database'       => @$_SERVER[ENV_PRE . 'DB_NAME'] ?: 'yfthink',
                // 数据库用户名
