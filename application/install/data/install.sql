# Dump of table yf_addon_link
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_addon_link`;

CREATE TABLE `yf_addon_link` (
...
LOCK TABLES `yf_addon_link` WRITE;
/*!40000 ALTER TABLE `yf_addon_link` DISABLE KEYS */;

INSERT INTO `yf_addon_link` (`id`, `title`, `logo`, `url`, `type`, `create_time`, `update_time`, `sort`, `status`)
VALUES
...
/*!40000 ALTER TABLE `yf_addon_link` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yf_admin_access
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_admin_access`;

CREATE TABLE `yf_admin_access` (
...
LOCK TABLES `yf_admin_access` WRITE;
/*!40000 ALTER TABLE `yf_admin_access` DISABLE KEYS */;

INSERT INTO `yf_admin_access` (`id`, `uid`, `group`, `create_time`, `update_time`, `sort`, `status`)
VALUES
  (1,1,1,1438651748,1438651748,0,1);

/*!40000 ALTER TABLE `yf_admin_access` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yf_admin_addon
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_admin_addon`;

CREATE TABLE `yf_admin_addon` (
...
LOCK TABLES `yf_admin_addon` WRITE;
/*!40000 ALTER TABLE `yf_admin_addon` DISABLE KEYS */;

INSERT INTO `yf_admin_addon` (`id`, `name`, `title`, `description`, `config`, `author`, `version`, `adminlist`, `type`, `create_time`, `update_time`, `sort`, `status`)
VALUES
  (1,'Frog','青蛙挂件','有什么能帮您的么？','{\"status\":\"1\",\"frog_say\":\"\\u6253100\\u5143\\u5230\\u6211\\u652f\\u4ed8\\u5b9d\\u6211\\u4eec\\u8fd8\\u662f\\u597d\\u670b\\u53cb~\"}','有范科技','1.0.0',0,0,1484561439,1484561439,0,1),
  (2,'Link','友情链接插件','友情链接插件','null','有范科技','1.0.0',1,0,1484561441,1484561441,0,1),
  (3,'RocketToTop','小火箭返回顶部','小火箭返回顶部','{\"status\":\"1\"}','有范科技','1.0.0',0,0,1484561441,1484561441,0,1);

/*!40000 ALTER TABLE `yf_admin_addon` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yf_admin_config
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_admin_config`;

CREATE TABLE `yf_admin_config` (
...
LOCK TABLES `yf_admin_config` WRITE;
/*!40000 ALTER TABLE `yf_admin_config` DISABLE KEYS */;

INSERT INTO `yf_admin_config` (`id`, `title`, `name`, `value`, `group`, `type`, `options`, `tip`, `create_time`, `update_time`, `sort`, `status`)
VALUES
  (1,'站点开关','TOGGLE_WEB_SITE','1',1,'toggle','0:关闭\r\n1:开启','站点关闭后将不能访问',1378898976,1406992386,1,1),
  (2,'网站标题','WEB_SITE_TITLE','yfthink',1,'text','','网站标题前台显示标题',1378898976,1379235274,2,1),
  (3,'网站口号','WEB_SITE_SLOGAN','云平台',1,'text','','网站口号、宣传标语、一句话介绍',1434081649,1434081649,3,1),
  ...
  (6,'网站描述','WEB_SITE_DESCRIPTION','一套基于统一核心的通用互联网+信息化服务解决方案，追求简单、高效、卓越。可轻松实现支持多终端的WEB产品快速搭建、部署、上线。系统功能采用模块化、组件化、插件化等开放化低耦合设计，应用商城拥有丰富的功能模块、插件、主题，便于用户灵活扩展和二次开发。',1,'textarea','','网站搜索引擎描述',1378898976,1379235841,6,1),
  ...
  (12,'公司地址','COMPANY_ADDRESS','花园东路盛景广场B座',3,'text','','',1481014768,1481014768,2,1),
...
/*!40000 ALTER TABLE `yf_admin_config` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yf_admin_group
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_admin_group`;

CREATE TABLE `yf_admin_group` (
...
LOCK TABLES `yf_admin_group` WRITE;
/*!40000 ALTER TABLE `yf_admin_group` DISABLE KEYS */;

INSERT INTO `yf_admin_group` (`id`, `pid`, `title`, `icon`, `menu_auth`, `create_time`, `update_time`, `sort`, `status`)
VALUES
  (1,0,'超级管理员','','',1426881003,1427552428,0,1);

/*!40000 ALTER TABLE `yf_admin_group` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yf_admin_hook
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_admin_hook`;

CREATE TABLE `yf_admin_hook` (
...
LOCK TABLES `yf_admin_hook` WRITE;
/*!40000 ALTER TABLE `yf_admin_hook` DISABLE KEYS */;

INSERT INTO `yf_admin_hook` (`id`, `name`, `description`, `addons`, `type`, `create_time`, `update_time`, `status`)
VALUES
...
/*!40000 ALTER TABLE `yf_admin_hook` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yf_admin_module
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_admin_module`;

CREATE TABLE `yf_admin_module` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
LOCK TABLES `yf_admin_nav` WRITE;
/*!40000 ALTER TABLE `yf_admin_nav` DISABLE KEYS */;

INSERT INTO `yf_admin_nav` (`id`, `group`, `pid`, `title`, `type`, `value`, `target`, `icon`, `lists_template`, `detail_template`, `create_time`, `update_time`, `sort`, `status`)
VALUES
...
/*!40000 ALTER TABLE `yf_admin_nav` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yf_admin_post
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_admin_post`;

CREATE TABLE `yf_admin_post` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
# Dump of table yf_admin_slider
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_admin_slider`;

CREATE TABLE `yf_admin_slider` (
...
# Dump of table yf_admin_upload
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_admin_upload`;

CREATE TABLE `yf_admin_upload` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
# Dump of table yf_admin_session
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_admin_session`;

CREATE TABLE `yf_admin_session` (
...
# Dump of table yf_admin_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yf_admin_user`;

CREATE TABLE `yf_admin_user` (
...
LOCK TABLES `yf_admin_user` WRITE;
/*!40000 ALTER TABLE `yf_admin_user` DISABLE KEYS */;

INSERT INTO `yf_admin_user` (`id`, `user_type`, `nickname`, `username`, `password`, `email`, `email_bind`, `mobile`, `mobile_bind`, `avatar`, `score`, `money`, `reg_ip`, `reg_type`, `create_time`, `update_time`, `status`)
VALUES
  (1,1,'超级管理员','admin','79cc780bd21b161230268824080b8476','',0,'',0,'0',0,0.00,0,'',1438651748,1438651748,1);

/*!40000 ALTER TABLE `yf_admin_user` ENABLE KEYS */;
UNLOCK TABLES;
