...
class Kefu extends Admin {
    ...
    public function index() {
        ...
        $builder->setMetaTitle("列表")  // 设置页面标题
                ...
                ->addTableColumn("avatar", "客服头像",'picture')
                ->addTableColumn("username", "客服名称")
    ...
    public function add() {
        if (request()->isPost()) {
            ...
            $builder->setMetaTitle("添加客服")  // 设置页面标题
                    ->setPostUrl(U("add"))      // 设置表单提交地址
                    
                    ->addFormItem("avatar", "picture", "客服头像", "建议大小100x100px 正方形图片")
                    ->addFormItem("username", "text", "客服名称", "请输入客服名称")
                    ->addFormItem("mobile", "text", "联系电话", "请输入联系电话")
                    ->addFormItem("password", "password", "登录密码", "请输入登录密码")
