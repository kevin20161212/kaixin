 ...
 */
class ColligateList extends Model {
    /**
     * 数据库真实表名
     ...
     * @author youfai.cn <280962430@qq.com>
     */
    protected $tableName = 'Colligate_list';
    ...
    protected $_validate = array(
        // array('uid', 'require', '请绑定微信用户', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
        array('username', 'require', '姓名不能为空', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
        array('mobile', 'require', '手机号不能为空', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
        //验证密码
